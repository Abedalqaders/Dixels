...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1ec32178-8220-43de-88fc-ba4e9deea226
```

> `1ec32178-8220-43de-88fc-ba4e9deea226` is the password of the certificate, you can change it to any password you want.

...
public class DixelsEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new DixelsDbContext(new DbContextOptionsBuilder<DixelsDbContext>().UseSqlite(_database.ConnectionString).Options));

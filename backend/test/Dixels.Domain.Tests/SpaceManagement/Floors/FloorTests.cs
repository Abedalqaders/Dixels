...
public class FloorTests
{
    ...
    {
        var floor = CreateFloor();
        var buildingHours = OperatingWindow.Create(new TimeOnly(0, 0), new TimeOnly(23, 59));

        Should.NotThrow(() => floor.SetOwnOperatingHours(OperatingWindow.Create(new TimeOnly(7, 0), new TimeOnly(20, 0)), buildingHours));
    ...
    public void SetOwnOperatingHours_rejects_a_window_wider_than_the_parent()
    {
        ...
        var exception = Should.Throw<BusinessException>(() =>
            floor.SetOwnOperatingHours(OperatingWindow.Create(new TimeOnly(6, 0), new TimeOnly(21, 0)), buildingHours));
    ...
    public void SetOwnOperatingHours_null_clears_back_to_inherit()
    {
        ...
        floor.SetOwnOperatingHours(OperatingWindow.Create(new TimeOnly(7, 0), new TimeOnly(20, 0)), buildingHours);

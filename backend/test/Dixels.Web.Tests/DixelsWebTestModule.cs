...
[DependsOn(
    ...
    typeof(DixelsWebModule),
    typeof(DixelsApplicationTestModule),
    typeof(DixelsEntityFrameworkCoreTestModule)
)]
public class DixelsWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<IMvcBuilder>(builder =>
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(DixelsWebModule).Assembly));
        });
